...
int main() {
    vector<vector<double> > X_train = Load_State("../resources/train_states.txt");
    vector<vector<double> > X_test = Load_State("../resources/test_states.txt");
    vector<string> Y_train = Load_Label("../resources/train_labels.txt");
    vector<string> Y_test = Load_Label("../resources/test_labels.txt");
